...
//Name: 01-wood-pers.ma
//Last modified: Wed, Nov 12, 2014 05:31:56 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 41.049121028913426 45.268638258753811 -58.774299775527069 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 77.344745555359054;
...
createNode lookAt -n "camera2_group";
	...
	setAttr ".db" 24.463976554468466;
	setAttr ".tws" 8.5377364625159387e-007;
createNode transform -n "camera2" -p "camera2_group";
	setAttr ".t" -type "double3" 25.30701924647817 6.9623289018805989 -21.675503059584177 ;
createNode camera -n "cameraShape2" -p "camera2";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".coi" 24.463976554468466;
	setAttr ".ow" 30;
	setAttr ".imn" -type "string" "camera2";
	setAttr ".den" -type "string" "camera2_depth";
	setAttr ".man" -type "string" "camera2_mask";
createNode transform -n "camera2_aim" -p "camera2_group";
	setAttr ".t" -type "double3" 5.1366001716512217 2.7046006645734839 -8.5031041337742721 ;
...
createNode lookAt -n "camera3_group";
	...
	setAttr ".a" -type "double3" 0 0 -1 ;
	setAttr ".ct" -type "double3" 5.2307546980296102 12.65634696898395 -3.4650335242200629 ;
...
createNode reference -n "cupRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|cup:pCylinder1" "translate" " -type \"double3\" -0.554544 2.342878 -4.814601"
...
createNode rigidSolver -n "rigidSolver";
	setAttr ".stm" 1;
	setAttr -s 3 ".gfr";
	setAttr -s 3 ".t[0:2]" -type "double3" -0.55454444218077725 2.3428778157976904 
		-4.8146007610780872 -12.854655 1.6960319999999998 -3.28719 0 -0.43751601365269988 
		0;
	setAttr -s 3 ".t";
...
createNode choice -n "rigidBody_tx";
	setAttr ".ihi" 0;
	setAttr -s 2 ".i";
	setAttr ".i[0]" -0.55454444218077725;
...
createNode choice -n "rigidBody_tz";
	setAttr ".ihi" 0;
	setAttr -s 2 ".i";
	setAttr ".i[0]" -4.8146007610780872;
