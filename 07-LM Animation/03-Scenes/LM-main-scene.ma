...
//Last modified: Wed, Nov 12, 2014 03:24:11 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".rp" -type "double3" 1.7408297026122455e-013 -2.5313084961453569e-014 0 ;
	setAttr ".rpt" -type "double3" -3.338617185653515e-013 8.9683998816437112e-015 -1.3581971345323731e-013 ;
...
createNode rigidSolver -n "rigidSolver";
	setAttr ".stm" 1;
	setAttr -s 3 ".gfr";
	setAttr -s 3 ".t[0:2]" -type "double3" 5.3139889767450716 2.3428778157976904 
		2.1023323821542244 -12.854655 1.6960320000000002 -3.28719 0 -0.43751601365269988 
		0;
	setAttr -s 3 ".t";
...
createNode choice -n "rigidBody_tx";
	setAttr ".ihi" 0;
	setAttr -s 2 ".i";
	setAttr ".i[0]" 5.3139889767450716;
...
createNode choice -n "rigidBody_tz";
	setAttr ".ihi" 0;
	setAttr -s 2 ".i";
	setAttr ".i[0]" 2.1023323821542244;
...
createNode choice -n "rigidBody_ty1";
	setAttr ".ihi" 0;
	setAttr -s 2 ".i";
	setAttr ".i[0]" 1.6960320000000002;
